...
public class CarMongo {
    ...
    public CarMongo(String serialNumber, String make, String model, int year, String engine, String fuel,
                    ...
                    List<String> imageUrl, List<OwnerBookedPeriod> bookedPeriod, boolean inUse) {
    ...
    public CarMongo(String serialNumber, String make, String model, int year, String engine, String fuel, String gear,
                    ...
                    Location pickUpPlace, List<String> imageUrl, boolean inUse) {
        this.serialNumber = serialNumber;
        this.make = make;
        this.model = model;
        this.year = year;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(serialNumber, make, model, year, engine, fuel, gear, wheelsDrive, doors, seats, fuelConsumption, features, carClass, pricePerDay, distance, about, pickUpPlace, imageUrl, bookedPeriod, inUse);
    }
}
